...
st.header("Расчет коммерческого предложения")
...
file, overview = grunteco(tonns,burt_length,density,weeks,burt_wall, euro)
st.dataframe(overview)

offer = st.button('Создать презентацию')
if offer:
    ...
    st.download_button(label = 'Cкачать коммерческое предложение',
